package ru.mai.cipher.cipher_thread.file.file_impl;

import lombok.AllArgsConstructor;
import ru.mai.cipher.cipher_thread.file.file_interface.FileThreadCipher;
import ru.mai.cipher.cipher_thread.file.file_interface.FileThreadTaskCipher;
...
public class FileThreadCipherImpl implements FileThreadCipher {
    ...
    @Override
    public String cipher(String pathToInputFile, String pathToOutputFile, FileThreadCipher.CipherAction action) throws IOException, ExecutionException, InterruptedException {
